...
public class FileInfo {
    ...
    public void moveFile(String folderName, boolean simulation, FileRepresentation treeFile) {
        ...
        try {
            if (simulation) {
                for (FileRepresentation f : treeFile.getFolders()) {
        ...
        if (!folderExist) {
            ...
            if (simulation) {
                treeFile.addChildFolder(folderName);
        ...
        if (simulation) {
            FileRepresentation parentRepresentation = null;
            FileRepresentation sourceRepresentation = null;
            logger.log(Level.ERROR, treeFile);
            logger.log(Level.ERROR, treeFile.getFolders());
            for (FileRepresentation folderRepresentation : treeFile.getFolders()) {
            ...
            parentRepresentation.addChildFile(file);
